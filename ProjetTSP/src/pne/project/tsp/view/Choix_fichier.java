...
public class Choix_fichier extends JDialog {
   	...
   	public Choix_fichier(){
   		
   	   	dialogue = new JFileChooser("data/xml");
   	   	dialogue.showOpenDialog(null);
   	   	
   	   	File fileSelected = dialogue.getSelectedFile();
   	   	if(fileSelected!=null){
   	   		System.out.println("Le fichier choisi est : " + fileSelected.getName());
   	   		
	   	   	if(!isXml(fileSelected.getName())){
	   	   		// GERER L'ERREUR DANS LE CAS OU LE FILE SELECTED N'EST PAS UN XML
	   	   	}
   	   	}
    ...
    static public void main(String args[]) {
        Choix_fichier fs = new Choix_fichier();
    }
